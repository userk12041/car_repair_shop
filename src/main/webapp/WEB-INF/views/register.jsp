...
<div class="register-card">
  <form method="post" action="registerOk" onsubmit="return validateForm()">
    ...
    <div class="form-row">
      ...
      <input type="tel" name="phone_number" id="phone_number" placeholder="010-1234-5678" pattern="^010-[0-9]{4}-[0-9]{4}$" required>
    </div>
    <div class="form-row">
    ...
    <div class="form-row">
      ...
      <input type="text" id="zipCode" name="zipCode" placeholder="우편번호" readonly onclick="sample4_execDaumPostcode()">
      <input type="text" id="address" name="address" placeholder="도로명 주소" readonly>
      <input type="text" id="detailaddress" name="detailaddress" placeholder="상세 주소" onclick="addrCheck()">
    </div>
    <div class="form-row">
...
<script>
  ...
  function checkId() {
    ...
    $.ajax({ url: "/idCheck", method: "GET", data: { user_id: userId }, success: function (res) {
      if (res === "usable") {
  ...
  function checkNick() {
    ...
    $.ajax({ url: "/nickCheck", method: "GET", data: { nickname: nickname }, success: function (res) {
      if (res === "usable") {
